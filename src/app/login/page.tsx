...
const Loginpage = () => {
    return (
        <div className="p-4 h[calc(100vh-6rem)] md:h-[75vh] flex items-center justify-center">
            {/* BOX*/}
            <div className="h-full bg-fuchsia-100 shadow-2xl rounded-md flex flex-col md:flex-row md:h-[70%] md:w-full lg:w-[70%] 2xl:w-1/2">
                {/* IMAGE CONTAINER*/}
                ...
                <div className="p-10 flex flex-col gap-8 md:w-1/2">
                    <h1 className="font-bold text-2xl xl:text-4xl text-red-500">Welcome</h1>
                    ...
                    <p className="text-sm lg:mt-4">Have a problem? &nbsp;
