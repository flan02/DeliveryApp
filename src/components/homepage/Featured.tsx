            ...
            <div className="w-max flex slider-track">
                {/*SINGLE ITEM*/}
                {
                    featuredProducts.map((item, i) => (
                        <div key={i} className=" h-[60vh] flex flex-col items-center justify-around py-8 hover:bg-fuchsia-50 transition-all duration-300 w-[100vw] md:w-[50vw] xl:w-[33vw] xl:-h-[90vh]">
                            {/* IMAGE CONTAINER */}
                            {
                                item.img && (
                                    <div className="relative flex-1 w-full hover:rotate-[60deg] transition-all duration-500">
                                        <Image src={item.img} alt="" fill className="object-contain" sizes="10" />
                                    </div>
                                )}
                            {/* TEXT CONTAINER */}
                            <div className="flex-1 flex flex-col items-center justify-center gap-2 text-center">
                                ...
                                <span className="text-xl font-bold">u$$ {item.price}0</span>
